...
In order to quantitatively improve the state of the science through collaboration and training, we create and engage with topical working groups to share data and expertise. Current working groups: [Methane Working Group](https://smithsonian.github.io/CCN-Community-Resources/mwg.html), [Soils Working Group](https://smithsonian.github.io/CCN-Community-Resources/swg.html).

## Coastal Carbon Stats

`r knitr::kable(read_csv("data/ccn_stats.csv"))`
...
**Read the CCN Blue Carbon Inventory Report**

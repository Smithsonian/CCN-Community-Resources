...
We take a flexible approach when it comes to data contribution, which can require more or less participation on the part of the data contributor. If a dataset already has a citable data publication and associated digital object identifier (DOI), we do the work to bring the dataset into our synthesis (with attribution), reaching out to the dataset authors to ensure that we are accurately representing their datase.

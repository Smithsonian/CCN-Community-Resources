...
subtitle: Improving predictions of methane emissions from coastal wetlands
---

*Overarching goal of CH4 working group:*
Improve predictions of methane emissions from coastal wetlands. Specifically, we aim to compile all methane flux data from coastal habitats (not mangroves) in the CONUS to parameterize and validate a set of nested process-based CH4 models.
